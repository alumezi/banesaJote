export function PrivacyPolicy() {
  return (
    <>
      ...
      <p>Last updated: January 04, 2022</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Banesa Jote, Agim Ramadani nr47 A-3
            Prishtine, Kosove.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Kosovo
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Banesa Jote, accessible from{' '}
            <a
              href="banesajote.com"
      ...
      <ul>
        <li>By email: arbnorlumezi@gmail.com</li>
      </ul>
    </>
  );
}
